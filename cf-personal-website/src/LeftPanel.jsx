        ...
        <nav className='nav'>
            <ul>
                <li className="nav__list">
                    <a href="#" onClick={()=>{onNavClick('about')} } className={`nav__item ${activeSection == 'about' ? "nav__item--active" : "" }`} >
                        <span className="nav__line"></span>
                        <p className="nav__text">About</p>
                    </a>
                </li>
                <li  className="nav__list">
                    <a href="#" onClick={()=>{onNavClick('experience')} } className={`nav__item ${activeSection == 'experience' ? "nav__item--active" : "" }`}>
                        <span className="nav__line"></span>
